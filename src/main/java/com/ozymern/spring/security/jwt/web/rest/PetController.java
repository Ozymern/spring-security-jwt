package com.ozymern.spring.security.jwt.web.rest;
...
import com.ozymern.spring.security.jwt.models.services.PetService;
...
public class PetController {
	...
	public ResponseEntity<Pet> getUser(@PathVariable("id") Long id) {
	...
	public ResponseEntity<Pet> updateUser(@PathVariable Long id, @RequestBody Pet pet) {
